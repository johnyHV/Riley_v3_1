 ...
 */
int motor_step(motor_control *motor_0, motor_control *motor_1, motor_wheel * wheel, bool dir_0, bool dir_1, bool enable, uint8_t time) {
    // urcenie smeru
 ...
 * @return Pocet spravenych krokov
 */
int motor_step(motor_control *motor, motor_wheel * wheel, bool dir, bool enable, uint8_t time) {
    //nastavenie smeru
